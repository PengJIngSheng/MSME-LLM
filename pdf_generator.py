...
<div class="page-footer">
  <span>Pepper Labs AI · Confidential · AI-Generated Report</span>
  <span>{now}</span>
</div>
...
<div class="cover">
  <div class="cover-hero">
    <div class="cover-eyebrow">PEPPER LABS AI</div>
    <div class="cover-title">{title}</div>
    <div class="cover-sub">AI-Generated {report_type}</div>
  ...
  <div class="cover-disclaimer">
    ℹ️ This report was automatically generated by Pepper Labs AI from the uploaded source document.
    All data is extracted from the source. Please verify critical figures before making business decisions.
  </div>
</div>
...
async def markdown_to_pdf(markdown_text: str, doc_type: str = "general") -> tuple:
    ...
    title = m.group(1).strip() if m else "AI Analysis Report"
